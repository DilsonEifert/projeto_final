...
function listar_usuarios(){
    ...
    .then((data) => {
        ...
        thead_tr.appendChild(td)
        td = document.createElement('td')
        td.appendChild(document.createTextNode('Usuário'))
        thead_tr.appendChild(td)
        ...
        for(i = 0; i < data.length; i++){
            ...
            td_descricao.appendChild(document.createTextNode(data[i].email))

            td_valor = document.createElement('td')
            td_valor.appendChild(document.createTextNode(data[i].usuario))
